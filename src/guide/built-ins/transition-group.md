...
- Los [modos de transición](./transition#modos-de-transicion) no están disponibles, porque ya no alternamos entre elementos mutuamente excluyentes.
...
:::tip
Cuando se utiliza en [plantillas del DOM](/guide/essentials/component-basics#advertencias-sobre-el-procesamiento-de-las-plantillas-del-dom), se debe hacer referencia a este como `<transition-group>`.
:::
