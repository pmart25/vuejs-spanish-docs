...
Mira también: [Escritura de Propiedades Computadas](/guide/typescript/options-api#escritura-de-propiedades-computadas) <sup class="vt-badge ts" />
...
Véase también: [Escritura de computed()](/guide/typescript/composition-api#escritura-de-computed) <sup class="vt-badge ts" />
