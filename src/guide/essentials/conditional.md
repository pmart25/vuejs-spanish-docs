...
::: warning Nota
No se recomienda usar `v-if` y `v-for` en el mismo elemento debido a la precedencia implícita. Consulta la [guía de estilo](/style-guide/rules-essential#evitar-usar-v-if-con-v-for) para más detalles.
:::
